            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_belajar :
                        Intent intent = new Intent(PilihKota.this,PilihKota.class);
                        startActivity(intent);
                        return true;
//                                     case R.id.nav_quiz :
//                        Intent intent1 = new Intent(PilihKota.this,Quiz.class);
...
//        getMenuInflater().inflate(R.menu.pilih_kota, menu);
        return true;
    }
