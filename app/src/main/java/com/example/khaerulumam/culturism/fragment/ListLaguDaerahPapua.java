 ...
 */
public class ListLaguDaerahPapua extends Fragment {
...
//    String[] Gbr;
    ...
    private String[] Judul = {"Apuse","Sajojo","Yamko Rambe Yamko"};


    public ListLaguDaerahPapua() {
