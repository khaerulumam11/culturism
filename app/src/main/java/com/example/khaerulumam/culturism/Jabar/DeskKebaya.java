 ...
 */
public class DeskKebaya extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // d = (TextView) view.findViewById(R.id.deskripsimakanan);
        ...
        as = DETAIL_PAKAIAN+"?id_pakaian=2";

        a.setImageResource(R.drawable.kebayasunda);
//        b.setText("Batagor");
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("pakaianjawabarat");
                    ...
                    c.setText("Pakaian ini berasal dari Jawa Barat");
