...
import static com.example.khaerulumam.culturism.config.Config.DETAIL_MAKANANKALIMANTAN;
import static com.example.khaerulumam.culturism.config.Config.DETAIL_MAKANANPAPUA;

/**
 * A simple {@link Fragment} subclass.
 */
public class DeskIkanManokwari extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        as = DETAIL_MAKANANPAPUA+"?id_makanan=1";

        a.setImageResource(R.drawable.ikanbakarmanokwari);
//        b.setText("Batagor");
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("makananpapua");
                    ...
                    c.setText("Makanan ini berasal dari Papua");
