 ...
 */
public class DeskLaguDaerah extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int songID = getRawResIdByName("bubuybulan");

        mediaPlayer = MediaPlayer.create(getContext(),songID);

        as = DETAIL_LAGU+"?id_lagu=1";
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("lagujawabarat");
                    ...
                    b.setText("Lagu ini berasal dari Jawa Barat");
