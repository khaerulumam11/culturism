 ...
 */
public class ListTarianDaerahPapua extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.sajojo, R.drawable.yospan};
    private String[] Judul = {"Tari Sajojo","Tari Yospan"};


    public ListTarianDaerahPapua() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "sajojo");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "yospan");
                                startActivity(intent);
                                break;
                        }
