 ...
 */
public class ListLaguDaerahKalimantan extends Fragment {
...
//    String[] Gbr;
    ...
    private String[] Judul = {"Indung - Indung","Cik - Cik Periook","Badindang Ria"};


    public ListLaguDaerahKalimantan() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "indung");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "cikperiuk");
                                startActivity(intent);
                                break;
                            case 2:
                                intent.putExtra("id", "badindang");
                                startActivity(intent);
                                break;
