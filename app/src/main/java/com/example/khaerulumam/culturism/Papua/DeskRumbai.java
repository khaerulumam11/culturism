...
import static com.example.khaerulumam.culturism.config.Config.DETAIL_PAKAIANPAPUA;

/**
 * A simple {@link Fragment} subclass.
 */
public class DeskRumbai extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // d = (TextView) view.findViewById(R.id.deskripsimakanan);
        ...
        as = DETAIL_PAKAIANPAPUA+"?id_pakaian=2";

        a.setImageResource(R.drawable.rokrumbai);
//        b.setText("Batagor");
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("pakaianpapua");
                    ...
                    c.setText("Pakaian ini berasal dari Papua");
