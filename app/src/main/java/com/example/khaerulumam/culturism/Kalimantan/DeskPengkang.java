 ...
 */
public class DeskPengkang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // d = (TextView) view.findViewById(R.id.deskripsimakanan);
        ...
        as = DETAIL_MAKANANKALIMANTAN+"?id_makanan=3";

        a.setImageResource(R.drawable.pengkang);
//        b.setText("Batagor");
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("makanankalimantan");
                    ...
                    c.setText("Makanan ini berasal dari Kalimantan");
