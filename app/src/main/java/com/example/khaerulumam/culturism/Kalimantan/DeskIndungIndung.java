...
import static com.example.khaerulumam.culturism.config.Config.DETAIL_LAGU;
import static com.example.khaerulumam.culturism.config.Config.DETAIL_LAGUKALIMANTAN;

/**
 * A simple {@link Fragment} subclass.
 */
public class DeskIndungIndung extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int songID = getRawResIdByName("indungindung");

        mediaPlayer = MediaPlayer.create(getContext(),songID);

        as = DETAIL_LAGUKALIMANTAN+"?id_lagu=1";
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("lagukalimantan");
                    ...
                    b.setText("Lagu ini berasal dari Kalimantan");
...
//        a.setText("Bubuy Bulan");
//        b.setText("Lagu daerah asal Jawa Barat");
//        c.setText("Bubuy bulan sangray bentang\n" +
//                "Panon poe\n" +
//                "Panon poe disasate\n" +
//                "\n" +
//                "Unggal bulan\n" +
