 ...
 */
public class DeskTariLeleng extends Fragment implements YouTubePlayer.OnInitializedListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        as = DETAIL_TARIANKALIMANTAN+"?id_tarian=1";
