...
import static com.example.khaerulumam.culturism.config.Config.DETAIL_TARIAN;


/**
 * A simple {@link Fragment} subclass.
 */
public class DeskTarianDaerah extends Fragment implements YouTubePlayer.OnInitializedListener {
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("tarianjawabarat");
                    ...
                    b.setText("Tarian ini berasal dari Jawa Barat");
