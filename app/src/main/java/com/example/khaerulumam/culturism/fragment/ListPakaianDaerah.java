 ...
 */
public class ListPakaianDaerah extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.beskap, R.drawable.kebayasunda,R.drawable.pangsi};
    private String[] Judul = {"Beskap","Kebaya Sunda","Pangsi"};


    public ListPakaianDaerah() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "beskap");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "kebaya");
                                startActivity(intent);
                                break;
                            case 2:
                                intent.putExtra("id", "pangsi");
                                startActivity(intent);
                                break;
