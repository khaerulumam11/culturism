...
import com.example.khaerulumam.culturism.DeskripsiMakanan;
import com.example.khaerulumam.culturism.R;
import com.example.khaerulumam.culturism.adapter.LaguData;
import com.example.khaerulumam.culturism.adapter.MakananData;
 ...
 */
public class ListMakananDaerah extends Fragment {
    ...
    private List<MakananModel> mItems = new ArrayList<>();
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.peyeum, R.drawable.karedok,R.drawable.batagor};
    private String[] Judul = {"Peyeum","Karedok","Batagor"};


    public ListMakananDaerah() {
...
//        loadJSON();
        ...
        adapter =  new ListMakananDaerah.RecyclerViewAdapter(gambar1,judul);
...
//                                MakananModel md = new MakananModel();
//                                md.setNama(data.getString("namamakanan"));
//                                md.setGambar(data.getInt("gambar"));
//                                mItems.add(md);
...
//                context = itemView.getContext();
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(getActivity().getBaseContext(), DeskripsiMakanan.class);
                        //  String deskprisi = "";
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "peyeum");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "karedok");
                                startActivity(intent);
                                break;
                            case 2:
                                intent.putExtra("id", "batagor");
                                startActivity(intent);
                                break;
