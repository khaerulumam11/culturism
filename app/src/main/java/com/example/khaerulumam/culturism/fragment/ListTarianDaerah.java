 ...
 */
public class ListTarianDaerah extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.merak, R.drawable.topeng};
    private String[] Judul = {"Tari Merak","Tari Topeng"};


    public ListTarianDaerah() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "merak");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "topeng");
                                startActivity(intent);
                                break;
                        }
