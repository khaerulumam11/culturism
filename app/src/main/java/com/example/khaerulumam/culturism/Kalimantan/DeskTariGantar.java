 ...
 */
public class DeskTariGantar extends Fragment implements YouTubePlayer.OnInitializedListener {
...
//        videoView = (VideoView) view.findViewById(R.id.videoView);
        ...
        as = DETAIL_TARIANKALIMANTAN+"?id_tarian=2";
        ...
        stringRequest = new StringRequest(Request.Method.GET, as, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("tariankalimantan");
                    ...
                    b.setText("Tarian ini berasal dari Kalimantan");
