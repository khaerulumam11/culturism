 ...
 */
public class ListMakananDaerahPapua extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.ikanbakarmanokwari, R.drawable.ikanbungkus,R.drawable.papeda};
    private String[] Judul = {"Ikan Bakar Manokwari","Ikan Bungkus","Papeda"};


    public ListMakananDaerahPapua() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "ikanbakar");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "ikanbungkus");
                                startActivity(intent);
                                break;
                            case 2:
                                intent.putExtra("id", "papeda");
                                startActivity(intent);
                                break;
