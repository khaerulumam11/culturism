...
import com.example.khaerulumam.culturism.DeskripsiTarian;
 ...
 */
public class ListTarianDaerahKalimantan extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.leleng, R.drawable.gantar};
    private String[] Judul = {"Tari Leleng","Tari Gantar"};


    public ListTarianDaerahKalimantan() {
...
//                context = itemView.getContext();
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(getActivity().getBaseContext(), DeskripsiTarian.class);
                        //  String deskprisi = "";
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "leleng");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "gantar");
                                startActivity(intent);
                                break;
                        }
