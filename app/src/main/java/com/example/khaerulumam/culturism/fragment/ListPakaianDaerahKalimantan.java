 ...
 */
public class ListPakaianDaerahKalimantan extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.bajusangkarut, R.drawable.kingbaba,R.drawable.sapeisapaq};
    private String[] Judul = {"Baju Sangkarut","King Baba dan King Bibinge","Sapei Sapaq"};


    public ListPakaianDaerahKalimantan() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "sangkarut");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "kingbaba");
                                startActivity(intent);
                                break;
                            case 2:
                                intent.putExtra("id", "sapei");
                                startActivity(intent);
                                break;
