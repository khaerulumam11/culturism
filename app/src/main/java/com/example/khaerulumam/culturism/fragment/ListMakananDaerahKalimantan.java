 ...
 */
public class ListMakananDaerahKalimantan extends Fragment {
...
//    String[] Gbr;
    ...
    private int[] Gambar = {R.drawable.iwak, R.drawable.bekepor,R.drawable.pengkang};
    private String[] Judul = {"Iwak Pakasam","Nasi Bekepor","Pengkang"};


    public ListMakananDaerahKalimantan() {
                ...
                a.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (getAdapterPosition()) {
                            case 0:
                                intent.putExtra("id", "iwak");
                                startActivity(intent);
                                break;
                            case 1:
                                intent.putExtra("id", "bekepor");
                                startActivity(intent);
                                break;
                            case 2:
                                intent.putExtra("id", "pengkang");
                                startActivity(intent);
                                break;
